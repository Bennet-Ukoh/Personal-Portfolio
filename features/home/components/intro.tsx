...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-20 max-w-[55rem] scroll-mt-[100rem] sm:mb-10"
    >
      <div className="flex flex-col items-center gap-8 text-center sm:flex-row sm:items-center sm:gap-12 sm:text-left">
        {/* Profile image */}
        <div className="relative shrink-0">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-[192px] w-[192px] rounded-full border-[0.35rem] border-white object-cover shadow-xl sm:h-[220px] sm:w-[220px]"
            />
          </motion.div>
        ...
        <div className="flex flex-col">
          ...
          <motion.p
            className="mb-6 text-base text-gray-600 dark:text-gray-400 sm:text-lg"
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="flex flex-wrap items-center justify-center gap-2 text-lg font-medium sm:justify-start"
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
